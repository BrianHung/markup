...
(window, function(a) {
    ...
    , function(e, o, a) {
        ...
        r=function() {
            return function(a) {
                ...
                return c.m=a, c.c=r, c.i=function(e) {
                    return e
                }
                , c.d=function(e, o, a) {
                    c.o(e, o)||Object.defineProperty(e, o, {
            ...
            , function(e, o, a) {
                ...
                ();
                var _=a(5), l=a(7), p=a(4), c=function() {
                    function j(e, o) {
                        var a=o.location, r=void 0===a?0: a, c=o.distance, n=void 0===c?100: c, d=o.threshold, i=void 0===d?.6: d, m=o.maxPatternLength, t=void 0===m?32: m, _=o.isCaseSensitive, l=void 0!==_&&_, s=o.tokenSeparator, f=void 0===s?/ +/g: s, g=o.findAllMatches, u=void 0!==g&&g, h=o.minMatchCharLength, y=void 0===h?1: h;
                        !function(e, o) {
                            if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")
                        }
                        (this, j), this.options= {
                            location: r, distance: n, threshold: i, maxPatternLength: t, isCaseSensitive: l, tokenSeparator: f, findAllMatches: u, minMatchCharLength: y
                        }
                    ...
                    return r(j, [ {
                        key:"search", value:function(e) {
                            ...
                            var c=this.options, n=c.location, d=c.distance, i=c.threshold, m=c.findAllMatches, t=c.minMatchCharLength;
                            return l(e, this.pattern, this.patternAlphabet, {
                                location: n, distance: d, threshold: i, findAllMatches: m, minMatchCharLength: t
                            }
                            )
                        }
                    }
            ...
            , function(e, o, a) {
                ...
                e.exports=function(e, o) {
                    return function e(o, a, r) {
                        if(a) {
                            var c=a.indexOf("."), n=a, d=null;
                            -1!==c&&(n=a.slice(0, c), d=a.slice(c+1));
                            var i=o[n];
                            if(null!=i)if(d||"string"!=typeof i&&"number"!=typeof i)if(_(i))for(var m=0, t=i.length;
                            m<t;
                            m+=1)e(i[m], d, r);
                            else d&&e(i, d, r);
            ...
            , function(e, o, a) {
                "use strict";
                e.exports=function() {
                    for(var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]: [], o=1<arguments.length&&void 0!==arguments[1]?arguments[1]: 1, a=[], r=-1, c=-1, n=0, d=e.length;
                    n<d;
                    n+=1) {
                        var i=e[n];
            ...
            , function(e, o, a) {
                ...
                var _ = /[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g;
                e.exports=function(e, o) {
                    var a=2<arguments.length&&void 0!==arguments[2]?arguments[2]: / +/g, r=new RegExp(o.replace(_, "\\$&").replace(a, "|")), c=e.match(r), n=!!c, d=[];
                    if(n)for(var i=0, m=c.length;
                    i<m;
                    i+=1) {
                        var t=c[i];
                    ...
                    return {
                        score: n?.5: 1, isMatch: n, matchedIndices: d
                    }
                }
            }
            , function(e, o, a) {
                "use strict";
                e.exports=function(e, o) {
                    var a=o.errors, r=void 0===a?0: a, c=o.currentLocation, n=void 0===c?0: c, d=o.expectedLocation, i=void 0===d?0: d, m=o.distance, t=void 0===m?100: m, _=r/e.length, l=Math.abs(i-n);
            ...
            , function(e, o, a) {
                ...
                e.exports=function(e, o, a, r) {
                    for(var c=r.location, n=void 0===c?0: c, d=r.distance, i=void 0===d?100: d, m=r.threshold, t=void 0===m?.6: m, _=r.findAllMatches, l=void 0!==_&&_, s=r.minMatchCharLength, f=void 0===s?1: s, g=n, u=e.length, h=t, y=e.indexOf(o, g), j=o.length, p=[], b=0;
                    b<u;
                    b+=1)p[b]=0;
                    if(-1!==y) {
                        var v=A(o, {
                            errors: 0, currentLocation: y, expectedLocation: g, distance: i
                        }
                        );
                    ...
                    y=-1;
                    for(var w=[], x=1, q=j+u, S=1<<j-1, C=0;
                    C<j;
                    C+=1) {
                        for(var E=0, L=q;
                        E<L;
                            ...
                            A(o, {
                                errors: C, currentLocation: g+L, expectedLocation: g, distance: i
                            }
                            )<=h?E=L:q=L, L=Math.floor((q-E)/2+E)
                        }
                        q=L;
                        var O=Math.max(1, g-L+1), z=l?u:Math.min(g+L, u)+j, M=Array(z+2);
                        M[z+1]=(1<<C)-1;
                        for(var T=z;
                        O<=T;
                        T-=1) {
                            var P=T-1, I=a[e.charAt(P)];
                            if(I&&(p[P]=1), M[T]=(M[T+1]<<1|1)&I, 0!==C&&(M[T]|=(w[T+1]|w[T])<<1|1|w[T+1]), M[T]&S&&(x=A(o, {
                                errors: C, currentLocation: P, expectedLocation: g, distance: i
                            }
                            ))<=h) {
                                if(h=x, (y=P)<=g)break;
                                O=Math.max(1, 2*g-y)
                        ...
                        if(h<A(o, {
                            errors: C+1, currentLocation: g, expectedLocation: g, distance: i
                        }
                        ))break;
                        w=M
                    }
                    return {
                        isMatch: 0<=y, score: 0===x?.001: x, matchedIndices: B(p, f)
                    }
                }
            }
            , function(e, o, a) {
                ...
                ();
                var n=a(1), N=a(2), A=a(0), c=function() {
                    function H(e, o) {
                        var a=o.location, r=void 0===a?0:a, c=o.distance, n=void 0===c?100:c, d=o.threshold, i=void 0===d?.6:d, m=o.maxPatternLength, t=void 0===m?32:m, _=o.caseSensitive, l=void 0!==_&&_, s=o.tokenSeparator, f=void 0===s?/ +/g:s, g=o.findAllMatches, u=void 0!==g&&g, h=o.minMatchCharLength, y=void 0===h?1:h, j=o.id, p=void 0===j?null:j, b=o.keys, v=void 0===b?[]:b, k=o.shouldSort, w=void 0===k||k, x=o.getFn, q=void 0===x?N:x, S=o.sortFn, C=void 0===S?function(e, o) {
                            return e.score-o.score
                        }
                        :S, E=o.tokenize, L=void 0!==E&&E, O=o.matchAllTokens, z=void 0!==O&&O, M=o.includeMatches, T=void 0!==M&&M, P=o.includeScore, I=void 0!==P&&P, A=o.verbose, B=void 0!==A&&A;
                        !function(e, o) {
                            if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")
                        }
                        (this, H), this.options= {
                            location: r, distance: n, threshold: i, maxPatternLength: t, isCaseSensitive: l, tokenSeparator: f, findAllMatches: u, minMatchCharLength: y, id: p, keys: v, includeMatches: T, includeScore: I, shouldSort: w, getFn: q, sortFn: C, verbose: B, tokenize: L, matchAllTokens: z
                        }
                    ...
                    , {
                        key:"search", value:function(e) {
                            this._log('---------\nSearch pattern: "'+e+'"');
                            var o=this._prepareSearchers(e), a=o.tokenSearchers, r=o.fullSearcher, c=this._search(a, r), n=c.weights, d=c.results;
                            return this._computeScore(n, d), this.options.shouldSort&&this._sort(d), this._format(d)
                        }
                    }
                    , {
                        key:"_prepareSearchers", value:function() {
                            var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]: "", o=[];
                            if(this.options.tokenize)for(var a=e.split(this.options.tokenSeparator), r=0, c=a.length;
                            r<c;
                            r+=1)o.push(new n(a[r], this.options));
                            return {
                                tokenSearchers: o, fullSearcher: new n(e, this.options)
                            }
                        }
                    }
                    , {
                        key:"_search", value:function() {
                            var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:[], o=arguments[1], a=this.list, r= {}
                            , c=[];
                            if("string"==typeof a[0]) {
                                for(var n=0, d=a.length;
                                n<d;
                                n+=1)this._analyze( {
                                    key: "", value: a[n], record: n, index: n
                                }
                                , {
                                    resultMap: r, results: c, tokenSearchers: e, fullSearcher: o
                                }
                                );
                                return {
                                    weights: null, results: c
                                }
                            }
                            for(var i= {}
                            , m=0, t=a.length;
                            m<t;
                            m+=1)for(var _=a[m], l=0, s=this.options.keys.length;
                            l<s;
                            l+=1) {
                                ...
                                ;
                                this._analyze( {
                                    key: f, value: this.options.getFn(_, f), record: _, index: m
                                }
                                , {
                                    resultMap: r, results: c, tokenSearchers: e, fullSearcher: o
                                }
                    ...
                    , {
                        key:"_analyze", value:function(e, o) {
                            var a=e.key, r=e.arrayIndex, c=void 0===r?-1:r, n=e.value, d=e.record, i=e.index, m=o.tokenSearchers, t=void 0===m?[]:m, _=o.fullSearcher, l=void 0===_?[]:_, s=o.resultMap, f=void 0===s? {}
                            : s, g=o.results, u=void 0===g?[]: g;
                            if(null!=n) {
                                var h=!1, y=-1, j=0;
                                if("string"==typeof n) {
                                    this._log("\nKey: "+(""===a?"-": a));
                                    var p=l.search(n);
                                    if(this._log('Full text: "'+n+'", score: '+p.score), this.options.tokenize) {
                                        for(var b=n.split(this.options.tokenSeparator), v=[], k=0;
                                        k<t.length;
                                        k+=1) {
                                            var w=t[k];
                                            this._log('\nPattern: "'+w.pattern+'"');
                                            ...
                                            q<b.length;
                                            q+=1) {
                                                var S=b[q], C=w.search(S), E= {}
                                                ;
                                                C.isMatch?(E[S]=C.score, x=h=!0, v.push(C.score)): (E[S]=1, this.options.matchAllTokens||v.push(1)), this._log('Token: "'+S+'", score: '+E[S])
                                            }
                                            x&&(j+=1)
                                        }
                                        y=v[0];
                                        for(var L=v.length, O=1;
                                        O<L;
                                        O+=1)y+=v[O];
                                        y/=L, this._log("Token score average:", y)
                                    }
                                    var z=p.score;
                                    -1<y&&(z=(z+y)/2), this._log("Score average:", z);
                                    var M=!this.options.tokenize||!this.options.matchAllTokens||j>=t.length;
                                    if(this._log("\nCheck Matches: "+M), (h||p.isMatch)&&M) {
                                        var T=f[i];
                                        T?T.output.push( {
                                            key: a, arrayIndex: c, value: n, score: z, matchedIndices: p.matchedIndices
                                        }
                                        ):(f[i]= {
                                            item:d, output:[ {
                                                key: a, arrayIndex: c, value: n, score: z, matchedIndices: p.matchedIndices
                                ...
                                else if(A(n))for(var P=0, I=n.length;
                                P<I;
                                P+=1)this._analyze( {
                                    key: a, arrayIndex: P, value: n[P], record: d, index: i
                                }
                                , {
                                    resultMap: f, results: u, tokenSearchers: t, fullSearcher: l
                                }
                                )
                            }
                        }
                    ...
                    , {
                        key:"_format", value:function(e) {
                            ...
                            this._log("\n\nOutput:\n\n", JSON.stringify(e));
                            var a=[];
                            this.options.includeMatches&&a.push(function(e, o) {
                                var a=e.output;
                                o.matches=[];
                                for(var r=0, c=a.length;
                                r<c;
                                r+=1) {
                                    var n=a[r];
                                    if(0!==n.matchedIndices.length) {
                                        var d= {
                                            indices: n.matchedIndices, value: n.value
                                        }
                                        ;
                            ...
                            ), this.options.includeScore&&a.push(function(e, o) {
                                o.score=e.score
                            }
                            );
                            for(var r=0, c=e.length;
                            r<c;
                            r+=1) {
                                var n=e[r];
                                if(this.options.id&&(n.item=this.options.getFn(n.item, this.options.id)[0]), a.length) {
                                    for(var d= {
                                        item: n.item
                                    }
                                    , i=0, m=a.length;
    ...
    , , function(e, o, a) {
        ...
        function i(e, o) {
            return!o||"object"!==n(o)&&"function"!=typeof o?function(e) {
        ...
        function m(e, o, a) {
            return(m="undefined"!=typeof Reflect&&Reflect.get?Reflect.get:function(e, o, a) {
                var r=function(e, o) {
                    for(;
                    !Object.prototype.hasOwnProperty.call(e, o)&&null!==(e=t(e));
                    );
                    return e
                }
                (e, o);
        ...
        function _(e, o) {
            return(_=Object.setPrototypeOf||function(e, o) {
                return e.__proto__=o, e
            }
            )(e, o)
        }
        var l=c.a.import("blots/embed"), s=function(e) {
            function r() {
                return function(e, o) {
                    if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")
                }
                (this, r), i(this, t(r).apply(this, arguments))
            }
            var o, a, c;
            return function(e, o) {
            ...
            (r, l), o=r, c=[ {
                key:"create", value:function(e) {
                    var o=m(t(r), "create", this).call(this);
                    if("object"===n(e)) {
                        o.setAttribute("data-name", e.name);
                        var a=document.createElement("span");
                        a.classList.add(this.emojiClass), a.classList.add(this.emojiPrefix+e.name), a.innerText=String.fromCodePoint("0x"+e.unicode), o.appendChild(a)
                    }
                    return o
                }
            }
            ...
            ], (a=null)&&d(o.prototype, a), c&&d(o, c), r
        }
        ();
        s.blotName="emoji", s.className="ql-emojiblot", s.tagName="span", s.emojiClass="ap", s.emojiPrefix="ap-";
        var f=s, g=a(1), u=a.n(g), h=[ {
        ...
        var k=c.a.import("core/module"), w=function(e) {
            function n(e, o) {
                var a, r, c;
                return function(e, o) {
                    if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")
                }
                (this, n), r=this, (a=!(c=p(n).call(this, e, o))||"object"!==y(c)&&"function"!=typeof c?v(r):c).emojiList=o.emojiList, a.fuse=new u.a(o.emojiList, o.fuse), a.quill=e, a.onClose=o.onClose, a.onOpen=o.onOpen, a.container=document.createElement("ul"), a.container.classList.add("emoji_completions"), a.quill.container.appendChild(a.container), a.container.style.position="absolute", a.container.style.display="none", a.onSelectionChange=a.maybeUnfocus.bind(v(v(a))), a.onTextChange=a.update.bind(v(v(a))), a.open=!1, a.atIndex=null, a.focusedButton=null, a.isWhiteSpace=function(e) {
                    var o=!1;
                ...
                , a.triggerPicker.bind(v(v(a)))), e.keyboard.addBinding( {
                    key: 186, shiftKey: !0
                }
                , a.triggerPicker.bind(v(v(a)))), e.keyboard.addBinding( {
                    key: 39, collapsed: !0, format: ["emoji-shortname"]
                }
                , a.handleArrow.bind(v(v(a)))), e.keyboard.addBinding( {
                    key: 40, collapsed: !0, format: ["emoji-shortname"]
                }
                , a.handleArrow.bind(v(v(a)))), a
            }
            var o, a, r;
            return function(e, o) {
                if("function"!=typeof o&&null!==o)throw new TypeError("Super expression must either be null or a function");
            ...
            (n, k), o=n, (a=[ {
                key:"triggerPicker", value:function(e, o) {
                    ...
                    0<e.length&&this.quill.deleteText(e.index, e.length, c.a.sources.USER), this.quill.insertText(e.index, ":", "emoji-shortname", c.a.sources.USER);
            ...
            , {
                key:"renderCompletions", value:function(e) {
                    ...
                    if(e.forEach(function(e, o) {
                        ...
                        , x("span", {
                            className: "button-emoji ap ap-"+e.name, innerHTML: e.code_decimal
                        }
                        ), x("span", {
                            className: "unmatched emoji-shortname",
                        }
                        , e.shortname)));
            ...
            , {
                key:"close", value:function(e) {
                    var o=this, a=1<arguments.length&&void 0!==arguments[1]?arguments[1]: 0;
                    for(this.quill.enable(), this.container.style.display="none";
                    this.container.firstChild;
                    )this.container.removeChild(this.container.firstChild);
                    this.quill.off("selection-change", this.onSelectionChange), this.quill.off("text-change", this.onTextChange), e&&(this.quill.deleteText(this.atIndex, this.query.length+1+a, c.a.sources.USER), this.quill.insertEmbed(this.atIndex, "emoji", e), setTimeout(function() {
                        return o.quill.setSelection(o.atIndex+1)
                    }
                    , 0)), this.quill.focus(), this.open=!1, this.onClose&&this.onClose(e)
                }
            }
            ])&&j(o.prototype, a), r&&j(o, r), n
        }
        ();
        function x(e, o) {
            ...
            for(var r=arguments.length, c=new Array(2<r?r-2:0), n=2;
            n<r;
            n++)c[n-2]=arguments[n];
        ...
        function E(e, o) {
            return!o||"object"!==S(o)&&"function"!=typeof o?function(e) {
                if(void 0!==e)return e;
                throw new ReferenceError("this hasn't been initialised - super() hasn't been called")
            }
            (e):o
        ...
        c.a.import("delta");
        var z=c.a.import("core/module"), M=function(e) {
            function c(e, o) {
                var a;
                !function(e, o) {
                    if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")
                }
                (this, c), (a=E(this, L(c).call(this, e, o))).quill=e, a.toolbar=e.getModule("toolbar"), void 0!==a.toolbar&&a.toolbar.addHandler("emoji", a.checkPalatteExist);
            ...
            (c, z), o=c, (a=[ {
                key:"checkPalatteExist", value:function() {
                    ...
                    e=r, (o=document.getElementById("emoji-palette"))?o.remove():function(c) {
                        var e=document.createElement("div"), o=(document.querySelector(".ql-toolbar"), c.getSelection()), a=c.getBounds(o.index);
                        ...
                        if(n.appendChild(i), null===document.getElementById("emoji-close-div")) {
                            ...
                            m.id="emoji-close-div", m.addEventListener("click", T, !1), document.getElementsByTagName("body")[0].appendChild(m)
                        }
                        ...
                        , {
                            ...
                            r.addEventListener("click", function() {
                                ...
                                e&&e.classList.remove("active"), r.classList.toggle("active"), function(e, o, a) {
                                    ...
                                    I(e.dataset.filter, o, a)
                                }
                                (r, d, c)
                            }
                            )
                        }
                        ), I("p", d, c), document.querySelector(".filter-people").classList.add("active")
                    }
        ...
        function I(e, n, d) {
            ...
            var i=P(d);
            o.map(function(e) {
                var o=document.createElement("span"), a=document.createTextNode(e.shortname);
                ...
                c&&c.addEventListener("click", function() {
                    ...
                    d.insertEmbed(i.index, "emoji", e), T()
                }
                )
            }
            )
        ...
        function R(e, o) {
            return(R=Object.setPrototypeOf||function(e, o) {
                return e.__proto__=o, e
            }
            )(e, o)
        }
        ...
        c.a.import("delta");
        var F=c.a.import("core/module"), U=function(e) {
            function n(e, o) {
                var a, r, c;
                return function(e, o) {
                    if(!(e instanceof o))throw new TypeError("Cannot call a class as a function")
                }
                (this, n), r=this, (a=!(c=N(n).call(this, e, o))||"object"!==B(c)&&"function"!=typeof c?D(r):c).quill=e, a.container=document.createElement("div"), a.container.classList.add("textarea-emoji-control"), a.container.style.position="absolute", a.container.innerHTML=o.buttonIcon, a.quill.container.appendChild(a.container), a.container.addEventListener("click", a.checkEmojiBoxExist.bind(D(D(a))), !1), a
            }
            var o, a, r;
            return function(e, o) {
                if("function"!=typeof o&&null!==o)throw new TypeError("Super expression must either be null or a function");
                ...
                key:"checkEmojiBoxExist", value:function() {
                    ...
                    if(a)a.remove();
                        ...
                        if(c.appendChild(n), null===document.getElementById("emoji-close-div")) {
                            var d=document.createElement("div");
                            d.id="emoji-close-div", d.addEventListener("click", K, !1), document.getElementsByTagName("body")[0].appendChild(d)
                        }
                        else document.getElementById("emoji-close-div").style.display="block";
                        ...
                        , {
                            ...
                            r.addEventListener("click", function() {
                                ...
                                W(r.dataset.filter, i, m)
                            }
                            )
                        }
                        ), window.innerHeight/2<this.quill.container.getBoundingClientRect().top&&(r.style.top="-250px"), e=i, o=this.quill, W("p", e, o), document.querySelector(".filter-people").classList.add("active")
                    }
                }
            }
            ])&&H(o.prototype, a), r&&H(o, r), n
        }
        ();
        function K() {
        ...
        function W(e, n, d) {
            ...
            o.map(function(e) {
                ...
                var c=document.querySelector(".bem-"+e.name);
                c&&c.addEventListener("click", function() {
                    d.insertEmbed(i.index, "emoji", e), K()
                }
                )
            }
            )
        ...
        a(2);
        c.a.register( {
            "formats/emoji": f, "modules/emoji-shortname": q, "modules/emoji-toolbar": A, "modules/emoji-textarea": Q
        }
        , !0);
        o.default= {
            EmojiBlot: f, ShortNameEmoji: q, ToolbarEmoji: A, TextAreaEmoji: Q
        }
    }
    ])
}
