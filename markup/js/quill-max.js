    ...
    return function(t) {
        ...
        var a = function() {
            ...
            y = function(t) {
                function e(t) {
                    o(this, e);
                    var n = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t));
                    return n.text = n.statics.value(t), n
                }
        ...
        var M = function(t) {
            function e(t, n) {
                o(this, e);
                var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                return r.textbox = r.root.querySelector('textarea'), r.listen(), r
            }
            return l(e, t), u(e, [{
                key: "listen",
                value: function() {
                ...
                value: function() {
                    ...
                    this.root.classList.remove("ql-hidden"), this.root.classList.add("ql-editing"), null != e ? this.textbox.value = e : t !== this.root.getAttribute("data-mode") && (this.textbox.value = ""), this.position(this.quill.getBounds(this.quill.selection.savedRange)), n.create && ("formula" === t && (this.textbox.value = ""), this.textbox.select()), this.textbox.setAttribute("placeholder", this.textbox.getAttribute("data-" + t) || ""), this.root.setAttribute("data-mode", t)
                }
            }, {
                key: "restoreFocus",
                value: function() {
                ...
                value: function() {
                    ...
                    switch (this.root.getAttribute("data-mode")) {
                        ...
                        case "formula":
                            if (!t) break;
                            this.linkRange && this.linkRange.length && this.quill.deleteText(this.linkRange.index, this.linkRange.length);
        ...
        function y(t, e) {
            ...
            if (n.prototype instanceof P.default.Embed) {
                var r = {},
                    o = n.value(t);
                null != o && (r[n.blotName] = o, "formula" === n.blotName && (r.length = n.value(t).length), e = (new q.default).insert(r, n.formats(t)))
        ...
        _.TEMPLATE = ['<span class="ql-tooltip-arrow"></span>', '<div class="ql-tooltip-editor">', '<textarea type="text" data-formula="e=mc^2" data-video="Embed URL" style="resize: none"></textarea>', '<a class="ql-close"></a>', "</div>"].join(""), e.BubbleTooltip = _, e.default = m
    }, function(t, e, n) {
        "use strict";
        ...
        var a = function() {
            ...
            x = function(t) {
                function e(t, n) {
                    o(this, e), null != n.modules.toolbar && null == n.modules.toolbar.container && (n.modules.toolbar.container = w);
                    var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                ...
                return l(e, t), u(e, [{
                    key: "extendToolbar",
                    value: function(t) {
                        t.container.classList.add("ql-snow"), this.buildButtons([].slice.call(t.container.querySelectorAll("button")), _.default), this.buildPickers([].slice.call(t.container.querySelectorAll("select")), _.default), this.tooltip = new k(this.quill, this.options.bounds), t.container.querySelector(".ql-link") && this.quill.keyboard.addBinding({
                            key: "K",
                            shortKey: !0
                        }, function(e, n) {
                    ...
                    s(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "listen", this).call(this), this.root.querySelector("a.ql-action").addEventListener("click", function(e) {
                        ...
                        if (null != e) {
                            if (0 === e.length && r === p.default.sources.USER) {
                                ...
                                var c = t.quill.scroll.descendant(O.FormulaBlot, e.index),
                                    f = a(c, 2),
                                    h = f[0],
                                    d = f[1];
                                if (null != h) {
                                    t.linkRange = new g.Range(e.index - d, h.length());
                                    var y = O.FormulaBlot.value(h.domNode);
                                    return t.root.querySelector("a.ql-preview").value = y, t.show(), t.edit("formula", y, {
                                        create: !1
        ...
        k.TEMPLATE = ['<a class="ql-preview" target="_blank" href="about:blank"></a>', '<textarea type="text" data-formula="e=mc^2" data-video="Embed URL" style="resize: none"></textarea>', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join(""), e.default = x
    }]).default
});
